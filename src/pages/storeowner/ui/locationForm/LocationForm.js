...
const LocationForm = (props) =>{
    ...
    const { toggleButton,addLocation, selectedLocation } = props

    const [formInput, submitting,{onChange,handleSubmit}] = useLocationForm(addLocation,selectedLocation,toggleButton)
