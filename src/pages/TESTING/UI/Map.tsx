...
import { isLatLngLiteral } from "@googlemaps/typescript-guards";
    ...
    const render = (status: Status) => {
      ...
      const MyMap = (props) => {
        ...
        const {data, selected, handleSelectedLocation} = props.dependencies

        console.log("map deps ", data, selected, handleSelectedLocation)
        //const { data } = props.useDataContext      
        //const {selected, handleSelectedLocation } = props.useLocationContext 
